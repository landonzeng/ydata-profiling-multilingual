...
def get_report_structure(config: Settings, summary: BaseDescription) -> Root:
    ...
    with tqdm(
        total=1, desc=_("rendering.generate_structure"), disable=disable_progress_bar
    ) as pbar:
